                    ...
                    @auth
                        ...
                        @if(Auth::user()->role === 'admin')
                            ...
                            <x-nav-link :href="route('kendaraan.index')" :active="request()->routeIs('kendaraan.*')">
                               ...
                               <x-nav-link :href="route('jadwal_service.index')" :active="request()->routeIs('jadwal.*')">
                                {{ __('Jadwal Service') }}
                            </x-nav-link>
                        @endif
                    @endauth
                    ...
                    @auth
                        @if(Auth::user()->role === 'approver')
                            <x-nav-link href="{{ route('approval.index') }}" :active="request()->routeIs('approval.index')">
                             ...
                             <x-nav-link href="{{ route('approval.riwayat') }}" :active="request()->routeIs('approval.riwayat')">
                                {{ __('Riwayat Saya') }}
                            </x-nav-link>
                        @endif
                    @endauth
